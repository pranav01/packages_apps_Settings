...
public class RadiumRecentsSettings extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener {

    private static final String TAG = "RadiumRecentsSettings";
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.radium_recents_settings);
